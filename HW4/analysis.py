...
def accuracy(list_of_points, labels, centroids_dict):
    ...
    data = update_assignment(list_of_points, labels, centroids_dict)
...
# The accuracy of the algorithm is 0.582. The images that have numbers closer to the centroids are
# better interpreted by the algorithm than the blurrier images that have numbers farther
# from the centroids.
